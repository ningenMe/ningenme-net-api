package ningenme.net.api.category.application.controller.comproCategoryGenreOneGet;
...
import ningenme.net.api.category.application.controller.comproCategoryGenreOneGet.view.ComproCategoryGenreView;
