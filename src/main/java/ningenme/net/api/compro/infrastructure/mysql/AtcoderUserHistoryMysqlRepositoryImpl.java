...
import ningenme.net.api.compro.domain.value.ContestId;
import ningenme.net.api.compro.domain.value.Performance;
import ningenme.net.api.compro.domain.value.Place;
import ningenme.net.api.compro.infrastructure.mysql.dto.AtcoderUserHistoryMysqlDto;
import ningenme.net.api.compro.infrastructure.mysql.mapper.AtcoderUserHistoryMysqlMapper;
